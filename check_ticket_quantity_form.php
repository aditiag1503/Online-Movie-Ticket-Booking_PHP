...
$rssum=mysql_query("select sum(seat_quantity) from reservation_master where screen_id='$sid' and show_time_id='$st_id' and ticket_type_id='$tid' and movie_name='$mov_tit'",$con);
